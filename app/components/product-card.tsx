      ...
      {!soldOut && (
        <div className="flex gap-2 px-4 pb-4">
          <button
            ...
            className="flex-1 rounded-2xl border border-[#344e41] py-2.5 text-xs font-medium text-[#344e41] transition hover:bg-[#d1cec4] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {addingToCart ? (
          ...
          <button
            ...
            disabled={addingToCart || isLoading}
            className="flex-1 rounded-2xl bg-[#344e41] py-2.5 text-xs font-medium text-[#dad7cd] transition hover:bg-[#24352b] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Buy now
          </button>
        </div>

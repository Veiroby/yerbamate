    ...
    <div className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="prose prose-stone max-w-none text-sm">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">1. Data controller</h2>
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">2. Purposes and legal basis</h2>
          <p className="mt-2 text-stone-600">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">3. Recipients and transfers</h2>
          <p className="mt-2 text-stone-600">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">4. Retention</h2>
          <p className="mt-2 text-stone-600">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">5. Your rights</h2>
          <p className="mt-2 text-stone-600">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">6. Children</h2>
          <p className="mt-2 text-stone-600">

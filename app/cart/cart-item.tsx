      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center rounded-lg border border-zinc-200">
          <button
            ...
            className="flex h-8 w-8 items-center justify-center text-zinc-600 hover:bg-zinc-50 disabled:opacity-40 disabled:cursor-not-allowed rounded-l-lg"
          ...
          <button
            ...
            disabled={loading}
            className="flex h-8 w-8 items-center justify-center text-zinc-600 hover:bg-zinc-50 disabled:opacity-40 disabled:cursor-not-allowed rounded-r-lg"
        ...
        <button
          ...
          disabled={loading}
          className="flex h-8 w-8 items-center justify-center text-zinc-400 hover:text-red-600 disabled:opacity-40"

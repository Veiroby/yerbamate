    ...
    <div className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="prose prose-stone max-w-none text-sm">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">1. Delivery areas and methods</h2>
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">2. Dispatch and delivery times</h2>
          <p className="mt-2 text-stone-600">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">3. Delivery address and receipt</h2>
          <p className="mt-2 text-stone-600">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">4. Risk and ownership</h2>
          <p className="mt-2 text-stone-600">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-900">5. Lost or damaged parcels</h2>
          <p className="mt-2 text-stone-600">
            ...
            <a href="/terms" className="text-emerald-700 underline">Terms and conditions</a>.
          </p>

          <h2 className="mt-6 text-base font-semibold text-stone-900">6. Returns and refunds</h2>
          <p className="mt-2 text-stone-600">

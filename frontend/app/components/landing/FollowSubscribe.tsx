...
export function FollowSubscribe() {
  ...
  return (
    <section
      className="bg-black px-3 py-12 sm:px-4 sm:py-14"
      aria-labelledby="newsletter-heading"
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-8 max-lg:max-w-none sm:flex-row sm:gap-12">
        <h2

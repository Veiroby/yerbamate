  ...
  return (
    <div className="min-h-screen bg-[#FEFAE0] text-[#283618]">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        <h1 className="heading-page mb-8">Terms and conditions</h1>
        <div className="prose max-w-none text-sm prose-p:text-[#606C38] prose-headings:text-[#283618]">
          ...
          <h2 className="mt-6 text-base font-bold uppercase tracking-wide text-[#283618]">1. Seller</h2>
          ...
          <h2 className="mt-6 text-base font-bold uppercase tracking-wide text-[#283618]">2. Contract and prices</h2>
          <p className="mt-2 text-[#606C38]">
          ...
          <h2 className="mt-6 text-base font-bold uppercase tracking-wide text-[#283618]">3. Delivery</h2>
          <p className="mt-2 text-[#606C38]">
            Delivery methods, times, and costs are set out in our{" "}
            <a href={`${prefix}/shipping-policy`} className="text-emerald-700 underline">Shipping policy</a>.
          </p>

          <h2 className="mt-6 text-base font-bold uppercase tracking-wide text-[#283618]">4. Right of withdrawal (14 days)</h2>
          <p className="mt-2 text-[#606C38]">
          ...
          <h2 className="mt-6 text-base font-bold uppercase tracking-wide text-[#283618]">5. Legal guarantee (conformity)</h2>
          <p className="mt-2 text-[#606C38]">
          ...
          <h2 className="mt-6 text-base font-bold uppercase tracking-wide text-[#283618]">6. Disputes and applicable law</h2>
          <p className="mt-2 text-[#606C38]">
